...
// const total = numbers.reduce((acc, element, index, arr) => {
//   console.log('acc', acc);
...
// const totalSum = numbers.reduce((acc, el) => acc + el, 0);
...
// const totalCars = getTotalAmount(cars);
...
// const tags = tweets.reduce((acc, elem) => {
//   acc.push(...elem.tags);
//   console.log(acc);
...
// const tags = tweets.reduce((acc, { tags }) => [...acc, ...tags], []);
// console.log(tags);
// const filteredTags = tags.filter((elem, i, arr) => arr.indexOf(elem) === i);
